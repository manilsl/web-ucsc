...
<body id="page1">
 ...
 %>
			...
			<%
				String actionType = "addtransactionstatus";
		...
		<div id="frame">
			<div id="content">
				<form action="TransactionStatusController" method="get">
					<center>
						<h2>Add New Transaction Status</h2>
						<table border="0" cellspacing="1">



							<tr>
								<td class="unandpwd">* Status Name :</td>
								<td><input type="text" name="statusName"
									placeholder="Enter Status Name" /></td>
							</tr>
