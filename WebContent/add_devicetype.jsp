	...
	<div id="maindiv">
		...
		<div id="frame">
			<div id="content">
				...
				<%
			String actionType = "addDeviceType";
			session.setAttribute("actionType", actionType);
		%>

				<h2 align="center">Add New Device Type</h2>
				<form action="DeviceTypeController" method="post">
					...
					<center>
						<table>
							...
							<tbody>
								...
								<tr>
									<td class="unandpwd">* Device Type :</td>
									<td><input type="text" name="name"
										placeholder="Enter Device Type" /></td>
								</tr>
								<tr>
