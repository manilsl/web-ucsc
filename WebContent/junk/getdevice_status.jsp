...
<%@page import="com.devicemgt.model.DeviceStatus"%>
...
<body id="page1">
 ...
 %>
		...
		<%
			LinkedList<DeviceStatus> deviceStatusList = (LinkedList<DeviceStatus>) session
				...
				<form action="DeviceStatusController" method="get">
					<table class="CSSTable" width="1300" height="80" border="1"
						...
						<tr>
							...
							<th width="70">Status Id</th>
							<th width="100">Status Name</th>


						</tr>
						<%
							if (deviceStatusList != null) {
									for (int y = 0; y < deviceStatusList.size(); y++) {
						%>
						<tr>

							<td align="center"><%=deviceStatusList.get(y).getDeviceStatusId()%></td>
							<td align="center"><%=deviceStatusList.get(y).getDeviceStatusName()%></td>
