...
<body id="page1">
 ...
 %>
		...
		<%
			LinkedList<TransactionStatus> transactionStatusList = (LinkedList<TransactionStatus>) session
					...
					<table class="CSSTable" width="1300" height="80" border="1"
						...
						<%
							if (transactionStatusList != null) {
									for (int y = 0; y < transactionStatusList.size(); y++) {
						%>
						<tr>

							<td align="center"><%=transactionStatusList.get(y)
								.getTransactionStatusId()%></td>
							<td align="center"><%=transactionStatusList.get(y)
								.getTransactionStatusName()%></td>
